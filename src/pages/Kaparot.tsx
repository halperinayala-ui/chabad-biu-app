      ...
      <div id="amount-selection-section" className="kaparot-amount-selection-box">
        ...
        <div className="kaparot-summary-note">
          ...
          <div className="note-text">
            ...
            <span>
              <strong>אם יש לכם מזומן בהישג יד:</strong> נהוג להחזיק שטר או מטבעות (בכל סכום שיש לכם) ולסובב מעל הראש כפי המנהג. את התרומה בפועל מבצעים כאן באשראי לפי הסכום שקבעתם – והכסף המזומן נשאר אצלכם.
              <br />
              <strong>אם אין לכם מזומן זמין:</strong> אפשר לומר את התפילה והנוסח גם ללא סיבוב, ומתן הצדקה באפליקציה משלים את פדיון הכפרות!
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="kaparot-card">
        ...
        <div className="rotation-guidance-box">
          ...
          <p className="rotation-instruction-desc">
            אם יש לכם מזומן בהישג יד – אוחזים בו (בכל סכום שיש לכם) ומסובבים <strong>3 פעמים</strong> מעל הראש. אם אין מזומן – אומרים את הנוסח הבא, ופדיון הכפרות מתקיים במלואו בתרומה:
          </p>
